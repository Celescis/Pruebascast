...
public class LocalPlayerActivity extends AppCompatActivity {
    ...
    public void onSelectAudioTrackClick(View view) {
        // Asegúrate de tener una sesión de Cast activa
        if (mCastSession == null || !mCastSession.isConnected()) {
            Log.e(TAG, "No Cast Session!");
            return;
        }
        ...
        // Obtener las pistas de audio del media actual
        ...
        List<MediaTrack> audioTracks = mediaInfo.getMediaTracks();
        if (audioTracks == null || audioTracks.isEmpty()) {
            Log.e(TAG, "No audio tracks available!");
            return;
        }

        // Crear una lista de nombres de pistas para mostrar en el diálogo
        CharSequence[] trackNames = new CharSequence[audioTracks.size()];
        for (int i = 0; i < audioTracks.size(); i++) {
            trackNames[i] = audioTracks.get(i).getName();
        }

        // Crear y mostrar un diálogo para seleccionar la pista de audio
        new AlertDialog.Builder(this)
                ...
                .setItems(trackNames, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        long[] trackIds = {audioTracks.get(which).getId()};
